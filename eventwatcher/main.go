...
var (
	...
	envEaseeAmqpConnectionString      string = "https://api.easee.com/api/accounts/login paolo.sebben@effectas.com Effectas&easee2025"                               //	os.Getenv("EASEE_AMQP_CONNECTION_STRING")
