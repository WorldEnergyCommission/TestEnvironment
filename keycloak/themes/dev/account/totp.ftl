...
<@layout.mainLayout active='totp' bodyClass='totp'; section>
    ...
    <#else>
        ...
        <ol>
            <li>
                <span class="text-bold">${msg("totpStep1")}</span>
            ...
            <#if mode?? && mode = "manual">
                <li>
                    <p class="d-inline-block text-bold">${msg("totpManualStep2")}</p>
                    <p><span id="kc-totp-secret-key">${totp.totpSecretEncoded}</span></p>
                    <p><a href="${totp.qrUrl}" id="mode-barcode">${msg("totpScanBarcode")}</a></p>
                </li>
                <li>
                    <span class="d-inline-block text-bold">${msg("totpManualStep3")}</span>
                    <ul>
            ...
            <#else>
                <li>
                    <p class="d-inline-block text-bold">${msg("totpStep2")}</p>
                    <p><img src="data:image/png;base64, ${totp.totpSecretQrCode}" alt="Figure: Barcode"></p>
                    <p><a href="${totp.manualUrl}" id="mode-manual">${msg("totpUnableToScan")}</a></p>
                </li>
            </#if>
            <li>
                <p class="d-inline-block text-bold">${msg("totpStep3")}</p>
        ...
        <form action="${url.totpUrl}" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-10 col-sm-12">
                    <input type="text" class="form-input" id="totp" name="totp" autocomplete="off" autofocus>
            ...
            <div class="col-2 col-sm-2">
                <label for="userLabel" class="form-label">${msg("totpDeviceName")}</label> <#if totp.otpCredentials?size gte 1><span class="required">*</span></#if>
            </div>

            <div class="col-10 col-sm-12">
                <input type="text" class="form-input" id="userLabel" name="userLabel" autocomplete="off">
            </div>
            </div>
