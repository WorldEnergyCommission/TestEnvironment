        ...
        this.OperatingSystem = function () {
            ...
            var OnInitStaticPage = function (RequestParamIDs) {
                ...
                if (RequestParamIDs[IDX_SOFTWARE_Name].getHasValues() ||
                    ...
                    if (widthDate == 0) {
                        html += '<tr><th style="width:' + widthName + 'px;">Name</th><th style="width:' + widthCompany + 'px;">Company</th><th style="width:' + widthVersion + 'px;">Version</th></tr>';
                    }
                    else {
                        html += '<tr><th style="width:' + widthName + 'px;">Name</th><th style="width:' + widthCompany + 'px;">Company</th><th style="width:' + widthDate + 'px;">Date</th><th style="width:' + widthVersion + 'px;">Version</th></tr>';
                    }				
                    ...
                    for (var i = 0; i < Rows; i++) {
                        html += '<td style="word-wrap:break-word;width:' + widthName + 'px;"><div id="' + RequestParamIDs[IDX_SOFTWARE_Name].parameterName + i + '"></div></td>';
                        html += '<td style="word-wrap:break-word;width:' + widthCompany + 'px;"><div id="' + RequestParamIDs[IDX_SOFTWARE_Company].parameterName + i + '"></div></td>';
                        if (widthDate != 0) {
                            html += '<td style="word-wrap:break-word;width:' + widthDate + 'px;"><div id="' + RequestParamIDs[IDX_SOFTWARE_Date].parameterName + i + '"></div></td>';
                        }
                        html += '<td style="word-wrap:break-word;width:' + widthVersion + 'px;"><div id="' + RequestParamIDs[IDX_SOFTWARE_Version].parameterName + i + '"></div></td>';
                        html += "</tr>";
                    }
                    html += '</table>';
                    html += '<br>';
