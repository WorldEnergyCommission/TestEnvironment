        ...
        this.moduleList = function (ModuleAddress, ModuleServiceTransferAddress, ModuleType) {
            ...
            this.IsArray = function (paramID) {
                ...
                switch (paramID) {
                    ...
                    case "TIME_Property_Timezones2_Len": Size = 80; break;
                ...
                for (var i = 0; i < ModuleAddress.length; i++) {
                    ...
                    switch (ModuleType[i]) {
                        ...
                        case 2:
                            ...
                            createProperty(iID, "NIC_Property_Friendlyname", PropertiesAddress, 7, 0, "VISIBLE STRING", 256, "read-write");
                            createProperty(iID, "NIC_Property_IPv4_DnsActive", PropertiesAddress, 8, 0, "VISIBLE STRING", 128, "read");
                        ...
                        case 3:
                            ...
                            createProperty(iID, "TIME_Property_SNTP_OffsetValue", PropertiesAddress, 6, 0, "SIGNED32", 4, "read-write");
                            
                            // BaseAddress + 2
                            var PropertiesAddress = parseInt(ModuleAddress[i], 10) + parseInt(2, 10);
                            createProperty(iID, "TIME_Property_Timezones_Len", PropertiesAddress, 0, 0, "UNSIGNED16", 2, "read-only");

                            // BaseAddress + 3
                            var PropertiesAddress = parseInt(ModuleAddress[i], 10) + parseInt(3, 10);
                            createProperty(iID, "TIME_Property_Timezones2_Len", PropertiesAddress, 0, 0, "UNSIGNED16", 2, "read-only");
                        ...
                        case 8:
                            ...
                            createProperty(iID, "TwinCAT_TcRouterStatusInfo_Property_MemoryMax", PropertiesAddress, 1, 0, "UNSIGNED64", 8, "read-only");
                            createProperty(iID, "TwinCAT_TcRouterStatusInfo_Property_MemoryAvailable", PropertiesAddress, 2, 0, "UNSIGNED64", 8, "read-only");
                            ...
                            // 0x8nnA – TcOs Instance Status Information
                            var PropertiesAddress = parseInt(ModuleAddress[i], 10) + parseInt(10, 10);
                            createProperty(iID, "TwinCAT_TcOsInstanceInfo_Property_Len", PropertiesAddress, 0, 0, "UNSIGNED16", 2, "read-only");
                            createProperty(iID, "TwinCAT_TcOsInstanceInfo_Property_MemoryMax", PropertiesAddress, 1, 0, "UNSIGNED64", 8, "read-only");
                            createProperty(iID, "TwinCAT_TcOsInstanceInfo_Property_MemoryAvailable", PropertiesAddress, 2, 0, "UNSIGNED64", 8, "read-only");
