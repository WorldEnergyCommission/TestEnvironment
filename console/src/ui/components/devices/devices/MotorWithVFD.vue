<template>
  ...
  >
        ...
        >
          <template #label>
            <div class="text-center" style="line-height: 1">
              {{ $t("devices.MotorWithVFD.mainView.sliderLabel") }}
            </div>
          </template>
          <template #value>
            <SliderBase
    ...
    <template #settings-view>
      <div class="motor-with-vfd-settings d-flex justify-center">
        <LabelUnitWrapper
...
/**
 * Component that represent MotorWithVFD device
 */
