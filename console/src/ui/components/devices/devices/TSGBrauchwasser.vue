<template>
  ...
  >
    <template #basic-controls>
      <div class="d-flex align-center tsg-brauchwasser">
    ...
    <template #settings-view>
      <div class="d-flex tsg-brauchwasser-settings-view">
        <div class="tsg-brauchwasser-settings-view-side flex-grow-1">
          <div>
            <InputFieldBase
          ...
          >
            <template #label> Pumpe Dauer Ein statt Impuls </template>
            <template #value>
              <PushButtonBase
                :variable-data="deviceData.data.mappings"
                button-size="35"
...
.tsg-brauchwasser-settings-view {
  width: 100%;
  @media all and (max-width: 930px) {
    flex-direction: column;
  }

  .tsg-brauchwasser-settings-view-side {
    &:first-of-type {
      padding-right: 8px;
      @media all and (max-width: 930px) {
        padding-right: 0;
