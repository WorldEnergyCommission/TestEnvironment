<template>
  <DeviceLayout :device-data="deviceData" :is-preview="isPreview" :preview-data="deviceData">
    <template #basic-controls>
      <div class="socket-switch d-flex justify-space-between align-center">
        <lynus-icon color="theme" name="socket-switch" size="35" />
        <SwitchBase
...
/**
 * Component that represent SocketSwitch device
 */
