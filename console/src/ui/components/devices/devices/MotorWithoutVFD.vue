<template>
  ...
  >
    ...
    <template #settings-view>
      <div class="motor-without-vfd-settings d-flex justify-center">
        <LabelUnitWrapper
          :variables-list-for-check="[deviceData.data.mappings.OutputField_actualValue]"
        >
          <template #value>
            <OutputFieldBase
              :is-decimal="true"
...
/**
 * Component that represent MotorWithoutVFD device
 */
