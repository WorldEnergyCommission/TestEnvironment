<template>
  ...
  >
    <template #basic-controls>
      <div class="consumption-service-device">
        <div class="field">
    ...
    <template #charts-view>
      <div class="consumption-service-charts-content">
        <SettingsCharts
...
import SettingsCharts from "@/ui/components/devices/mpc/ConsumptionService/SettingsCharts/index.vue";

/**
 * Component that represent ConsumptionService MPC
 */
...
.consumption-service-charts-content {
  min-height: 84dvh;
}
</style>
