import EnergyFlowViewComponent from "./EnergyFlowView.vue";

export default {
  title: "Devices/MPC/EMS/systems/EnergyFlowView",
  component: EnergyFlowViewComponent,
};
  ...
  args: {
    allSystemsData: {
      ...
      heatProducer: {
        components: {
          heatProducer1: {
            power: "heatProducerPower",
            systemType: "heatProducer",
            title: "Title",
            interval: undefined,
            error: "",
          },
      ...
      heatMeter: {
        components: {
          heatMeter1: {
            power: "heatMeterPower",
            systemType: "heatMeter",
            title: "Title",
            interval: undefined,
            error: "",
          },
