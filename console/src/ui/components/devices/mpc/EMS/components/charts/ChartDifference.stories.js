...
import ChartDifferenceComponent from "./ChartDifference.vue";

export default {
  title: "Devices/MPC/EMS/ChartDifference",
  component: ChartDifferenceComponent,
};
