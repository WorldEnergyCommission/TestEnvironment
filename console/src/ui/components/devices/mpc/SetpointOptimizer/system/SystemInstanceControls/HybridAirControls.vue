          ...
          <div class="d-flex flex-grow-1 flex-column">
            <div class="d-flex justify-end pb-2">
              <div class="text-center" style="width: 120px">
                {{ labelSystemsSettingsHeating }}
              </div>
              <div class="text-center" style="width: 120px">
                {{ labelSystemsSettingsCooling }}
              </div>
            </div>
            <div class="d-flex flex-grow-1">
              <div class="flex-grow-1">
                ...
                <InputFieldExternal
                  v-model.number="settings.max_flow_temperature.heating"
                  :min="0"
                  :max="100"
                  :height="24"
                  :step="0.01"
                  ...
                  :unit-styles="{ width: '30px' }"
                  :description-styles="{ flexGrow: '1' }"
                  :input-field-styles="{ width: '90px' }"
                >
                ...
                <InputFieldExternal
                  v-model.number="settings.min_flow_temperature.heating"
                  :min="0"
                  :max="100"
                  :step="0.01"
                  :height="24"
                ...
                <InputFieldExternal
                  v-model.number="settings.set_point_temperature.heating"
                  :min="0"
                  :max="100"
                  :height="24"
                  :step="0.01"
              ...
              <div>
                <!-- Max Flow Temperature Cooling -->
                <InputFieldExternal
                  v-model.number="settings.max_flow_temperature.cooling"
                  :min="0"
                  :max="100"
                  :height="24"
                  :step="0.01"
                ...
                <InputFieldExternal
                  v-model.number="settings.min_flow_temperature.cooling"
                  :min="0"
                  :max="100"
                  :height="24"
                  :step="0.01"
                ...
                <!-- Set Point Temperature Cooling -->
                <InputFieldExternal
                  v-model.number="settings.set_point_temperature.cooling"
                  :min="0"
                  :max="100"
                  :height="24"
                  :step="0.01"
...
const settings = ref({
  identifier: "",
  max_flow_temperature: { cooling: 0, heating: 0 },
  min_flow_temperature: { cooling: 0, heating: 0 },
  set_point_temperature: { cooling: 0, heating: 0 },
...
// Translations
const labelOptimizedSupplyTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.optimized_supply_temperature.label",
);

const labelSystemsSettingsHeating = t("mlModel.SetpointOptimizer.systemsSettings.heating");

const labelSystemsSettingsCooling = t("mlModel.SetpointOptimizer.systemsSettings.cooling");

const labelMaxFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.max_flow_temperature.label",
);

const labelMinFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.min_flow_temperature.label",
);

const labelSetPointTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.set_point_temperature.label",
);

const labelFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.flow_temperature.label",
);

const labelReturnTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.return_temperature.label",
);

const labelOutInFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.out_in_flow_temperature.label",
);

const labelInOutFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.in_out_flow_temperature.label",
);

const labelStatus = t("mlModel.SetpointOptimizer.systems.hybrid_air_systems.mappings.status.label");

const labelRoomTemperatures = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.room_temperatures.label",
);
