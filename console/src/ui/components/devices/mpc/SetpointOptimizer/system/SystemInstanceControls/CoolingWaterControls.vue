<template>
  <div class="cooling-water-controls">
...
const labelMaxFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.max_flow_temperature.label",
);

const labelMinFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.min_flow_temperature.label",
);

const labelSetPointTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.set_point_temperature.label",
);

const labelFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.flow_temperature.label",
);

const labelReturnTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.return_temperature.label",
);

const labelStatus = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.status.label",
);

const labelRoomTemperatures = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.room_temperatures.label",
);

const labelOptimizedSupplyTemperature = t(
  "mlModel.SetpointOptimizer.systems.cooling_water_systems.mappings.optimized_supply_temperature.label",
);
