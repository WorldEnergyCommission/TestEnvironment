<template>
  <div class="heating-air-controls">
...
const labelMaxFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.max_flow_temperature.label",
);

const labelMinFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.min_flow_temperature.label",
);

const labelSetPointTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.set_point_temperature.label",
);

const labelFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.flow_temperature.label",
);

const labelReturnTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.return_temperature.label",
);

const labelOutInFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.out_in_flow_temperature.label",
);

const labelInOutFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.in_out_flow_temperature.label",
);

const labelStatus = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.status.label",
);
...
const labelOptimizedSupplyTemperature = t(
  "mlModel.SetpointOptimizer.systems.heating_air_systems.mappings.optimized_supply_temperature.label",
);
