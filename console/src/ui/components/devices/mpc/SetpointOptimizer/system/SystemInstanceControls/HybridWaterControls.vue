<template>
  <div class="hybrid-water-controls">
...
const labelOptimizedSupplyTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.optimized_supply_temperature.label",
);
...
const labelMaxFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.max_flow_temperature.label",
);

const labelMinFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.min_flow_temperature.label",
);

const labelSetPointTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.set_point_temperature.label",
);

const labelFlowTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.flow_temperature.label",
);

const labelReturnTemperature = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.return_temperature.label",
);

const labelStatus = t(
  "mlModel.SetpointOptimizer.systems.hybrid_water_systems.mappings.status.label",
);
