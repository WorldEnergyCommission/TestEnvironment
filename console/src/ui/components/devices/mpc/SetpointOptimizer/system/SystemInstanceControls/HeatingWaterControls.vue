<template>
  <div class="heating-water-controls">
    <SystemsInstanceControlsTemplate>
      <template #left-side>
        ...
        >
          <template #label> {{ labelFlowTemperature }} </template>
          <template #value>
            <OutputFieldBase
...
// Translations
const labelMaxFlowTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.max_flow_temperature.label",
);

const labelMinFlowTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.min_flow_temperature.label",
);

const labelSetPointTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.set_point_temperature.label",
);

const labelFlowTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.flow_temperature.label",
);

const labelReturnTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.return_temperature.label",
);

const labelStatus: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.status.label",
);

const labelOptimizedSupplyTemperature: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.optimized_supply_temperature.label",
);

const labelRoomTemperatures: string = t(
  "mlModel.SetpointOptimizer.systems.heating_water_systems.mappings.room_temperatures.label",
);
