import EnergyViewModuleComponent from "./EnergyViewModule.vue";

export default {
  title: "Devices/Modules/EnergyViewModule",
  component: EnergyViewModuleComponent,
};

export const EnergyViewModule = {
  args: {
    deviceData: {
      name: "Energy View",
      type: "EnergyView",
