...
export function getWhitelabelNameForWhitelabelApp(app: WhitelabelApp): WhitelabelName {
  switch (app) {
    case WhitelabelApp.ios_eneries: {
      return WhitelabelName.eneries;
    }
    case WhitelabelApp.android_eneries: {
      return WhitelabelName.eneries;
    }
  ...
  switch (name) {
    case WhitelabelName.eneries: {
      return {
        ...
        LOGO_URL_LIGHT: "/images/adamLight2.svg",
        LOGO_URL_DARK: "/images/adamLight2.svg",
        FAVICON_URL: "/images/eneries_favicon.ico",
        LOGIN_LOGO: "/images/adamLight.svg",
        LOGIN_LOGO_DARK: "/images/adamLight.svg",
        LOGIN_BACKGROUND: "/images/login/background-adam.jpg",
        REALM: "eneries",
