...
27. Add and configure the corresponding Keycloak theme to the directory **keycloak/themes/{whitelabel_name}**, change the corresponding images in the Keycloak template (used for mail verification, for example) - the relevant images to change are in **keycloak/themes/{whitelabel_name}/common/resources/img/** folder, change the main color in the **keycloak/themes/eneries/common/resources/css/spectre.min.css** file to match the main color of the whitelabel, also click through all the keycloak theme files and replace hardcodings
